...
@section('content')
    <div class="col-12">
        <form method="POST" action="{{ route('al.update', $al->id) }}">
            @method('PUT')
            @csrf
            <div class="card">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('date') is-invalid @enderror"
                                    id="date" name="date" value="{{ old('date', $al->date) }}">
                                @error('date')
                                ...
                                <select id="dietary_preference_id"
                                    ...
                                    @foreach ($dp as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('dietary_preference_id', $al->dietary_preference_id) == $item->id ? 'selected' : '' }}>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="commuting_method_id"
                                    ...
                                    @foreach ($cm as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('commuting_method_id', $al->commuting_method_id) == $item->id ? 'selected' : '' }}>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('commuting_method_value') is-invalid @enderror"
                                    ...
                                    value="{{ old('commuting_method_value', $al->commuting_method_value) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="energy_source_id"
                                    ...
                                    @foreach ($es as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('energy_source_id', $al->energy_source_id) == $item->id ? 'selected' : '' }}>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('energy_source_value') is-invalid @enderror"
                                    ...
                                    value="{{ old('energy_source_value', $al->energy_source_value) }}">
